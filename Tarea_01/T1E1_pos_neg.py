...
Brief:      Programa que obtiene un numero entero o flotante y determina si es positivo, negativo o cero.
Score:      85
Version:    1.1.1
Fixes:      Te hace falta la condición de __main__
            PEP8 recomienda no usar múltiples declaraciones en una sola línea de código.
"""
